...
dico = {}
#Tuple contennant les substrings qui indiquent que l'impossibilite de se connecter a l'equipement est normale
...
#On recupere la premiere et la seconde partie de chaque ligne du fichier (les adresses ip et nom de l'equipement). Si l'equipement contient une substring qui permet de l'identifier comme étant ininteressant, on n'en tient pas compte.
